...
<body style="background-color: #efefef; width: 1300px;">
	<div class="container">
		<div id="CountDownTimer" data-timer="1800"
	...
	<div id="body1" class="home" style="width: 1000px;">
		...
		<form action="resultpp" method="post" id="quiz" name="quiz"
			...
			<div id="lessonThree" class="wrap shadow-bottom ">
				<div id="res_sri" style="float: right">
					...
					<div id="ans" class="bigfont" style="font-size: 30px; color: red;"></div>
				</div>

				<ul>
					<s:iterator value="ppquestionlist" status="counter" var="user">
						<li>
