...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav">
			...
			<li class="active"><a href="softwaretesting">Testing</a></li>
...
<center>
	<section>
		...
		<div class="subsection">
			<ul>
				<li class="tip_text1">1. Manual Testing <span
					class="hover_text"> <a target="_blank"
						href="https://www.tutorialspoint.com/software_testing_dictionary/manual_testing.htm">Link
							1</a><br> <a target="_blank" href="http://www.etestinghub.com/">Link
							2</a>
				</span><br>
				</li>
				<br>
				<br>
				<li class="tip_text1">2. Selenium <span class="hover_text">
						<a target="_blank"
						href="https://www.tutorialspoint.com/selenium/index.htm">Link
							1</a><br> <a target="_blank" href="http://www.seleniumhq.org/">Link
							2</a><br> <a target="_blank" href="http://www.etestinghub.com/">Link
							3</a>
				</span><br>
				</li>
				<br>
